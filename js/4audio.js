...
// Load sounds
audioLoader.load('/portfolio/audio/ambiance.ogg', function(buffer) {
...
audioLoader.load('/portfolio/audio/switch.ogg', function(buffer) {
    sound2.setBuffer(buffer);
    sound2.setVolume(0.01);
});

audioLoader.load('/portfolio/audio/beep.ogg', function(buffer) {
